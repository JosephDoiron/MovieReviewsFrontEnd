...
import { getFeaturedMovies } from "../api";
...
export default function HomePage() {
  ...
  useEffect(() => {
    getFeaturedMovies()
      ...
      .catch(() => setError("Could not load featured movies. Is the API running?"))
  ...
  return (
    <>
      ...
      <section className="relative bg-navy overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#0f7a6d]/90 to-[#001a3a]/15" />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {loading && (
          <p className="text-gray-400 text-sm">Loading featured movies...</p>
        )}
        {error && (
